...
random_results_a, dataset_results_a, manual_results_a = hmm_performance.obs_probability_test('OrdonezA', datetime(2011, 11, 28, 0, 0, 0), datetime(2011, 12, 11, 0, 0, 0))
random_results_b, dataset_results_b, manual_results_b= hmm_performance.obs_probability_test('OrdonezB', datetime(2012, 11, 12, 0, 0, 0), datetime(2012, 12, 02, 0, 0, 0))
